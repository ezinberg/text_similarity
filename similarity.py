...
def similarity(t1, t2):
  ...
  # metric:
  # delta_u := number of unigrams that are included in one text and missing in the
  #   other text
  # delta_b := number of bigrams that are included in one text and missing in the
  #   other text
  # total_u := total number of unigrams in both texts
